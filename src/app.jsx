  ...
  return (
    <div style={{ width: 1440, minHeight: 1080, background: PH.bg, color: PH.ink,
      ...
      <div style={{ position: "absolute", inset: 0, pointerEvents: "none", zIndex: 1,
        backgroundImage: "repeating-linear-gradient(0deg, rgba(255,85,255,0.025), rgba(255,85,255,0.025) 1px, transparent 1px, transparent 3px)" }} />
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
        ...
        <div>
          ...
          <div style={{ fontFamily: PH.serif, fontSize: 26, color: PH.accent, lineHeight: 1, marginTop: 4,
            textShadow: "0 0 18px rgba(255,85,255,0.35)" }}>Art Van Delay 2</div>
        </div>
